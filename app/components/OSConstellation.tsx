export function OSConstellation() {
  return (
    <div className="platform-map" aria-label="Eidolon 产品架构：Eidolon One、官方外设与第三方设备共同构建在 Eidolon OS 和 EID-X 协议之上">
      <div className="platform-map-note"><span>ONE OS</span><b>MANY PRODUCTS</b></div>
      ...
      <div className="platform-os"><span>PERSONAL AI OPERATING SYSTEM</span><b>Eidolon OS</b><p>身份 · 记忆 · Agent · 情境 · 权限 · 模型</p></div>
      <div className="platform-protocol"><b>EID-X</b><span>DEVICE &amp; CAPABILITY PROTOCOL</span><i /><i /><i /></div>
      <p className="platform-caption">One 是官方旗舰，不是 OS 本身。<br />所有产品共享同一套系统能力与连接规则。</p>
    </div>
  );
}
