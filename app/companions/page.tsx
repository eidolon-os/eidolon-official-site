...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Eidolon Companions | 找到与你合拍的伙伴", description: "小铮、青芽、澄澄、烁烁、团团。认识五位原创 AI 伙伴。产品预览。", images: [{ url: "/companions/five-companions.png", alt: "五位 Eidolon 伙伴的原创角色概念形象" }] },
};
...
export default function CompanionsPage() {
  return <main className="site-shell site-light cp-page">
    ...
    <section className="cp-hero" id="top">
      <div className="cp-hero-copy"><p className="cp-label">EIDOLON COMPANIONS <span>角色陪伴 · 产品预览</span></p><h1>让日常，<br />多一个合拍的伙伴。</h1><p className="cp-lead">有的陪你理清思绪，有的陪你天马行空。<br />选一位喜欢的伙伴，让每次开口都有熟悉的回应。</p><div className="cp-actions"><a className="cp-button" href="#characters">认识五位伙伴 <span>↗</span></a><a className="cp-text-link" href="#begin">看看如何开始 ↓</a></div></div>
      <figure className="cp-family"><img src="/companions/five-companions.png" width="1942" height="809" fetchPriority="high" alt="从左到右：白金色猫头鹰小铮、苔绿色小鹿青芽、雾蓝色水獭澄澄、珊瑚橙狐狸烁烁、暖赭色小熊团团" /><figcaption>原创角色形象概念 · 非最终设备外观</figcaption></figure>
    ...
    <section className="cp-status cp-section"><p className="cp-label">WHERE WE ARE</p><h2>先把陪伴做好。</h2><div className="cp-status-grid"><article><b>正在打磨</b><p>五位角色预设、自定义设定，以及兼容桌面设备的接入与表达配置。</p></article><article><b>接下来的产品方向</b><p>围绕同一台主机，逐步推出可单独选择、组合使用的角色陪伴设备。之后再探索会转身、会移动的轻量伙伴。</p><Link className="cp-text-link" href="/ensemble">想让几位伙伴一起聊？看看 IP 角色团 ↗</Link></article></div><p className="cp-note">本页为产品预览，不是发售页面。角色形象、设备外观和组合形式仍在设计中，尚未公布价格与上市时间。</p><Link className="cp-button" href="/one">认识伙伴背后的主机 <span>↗</span></Link></section>
