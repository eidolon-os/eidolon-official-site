...
export default function CompanionsPage() {
  return <main className="site-shell site-light cp-page">
    ...
    <section className="cp-status cp-section"><p className="cp-label">ONE HOST, MORE SCENES</p><h2>陪伴，只是一个开始。</h2><div className="cp-status-grid"><article><b>让几位伙伴一起聊</b><p>单独聊、一起出主意、放手让他们讨论，伙伴们在各自的设备上轮流回应。</p><Link className="cp-text-link" href="/ensemble">看看 IP 角色团 ↗</Link></article><article><b>让伙伴帮你照看家</b><p>在书房对伙伴说「把客厅空调关了」，家里的设备跟着动起来。</p><Link className="cp-text-link" href="/smart-home">看看智能家居 ↗</Link></article></div><Link className="cp-button" href="/one">认识伙伴背后的主机 <span>↗</span></Link></section>
