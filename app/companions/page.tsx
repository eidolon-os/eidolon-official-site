...
export default function CompanionsPage() {
  return <main className="site-shell site-light cp-page">
    ...
    <section className="cp-section" id="begin"><div className="cp-section-heading"><div><p className="cp-label">03 / MAKE ROOM FOR A COMPANION</p><h2>从一位开始，<br />慢慢认识更多。</h2></div><p>伙伴住在你的 Eidolon One 里，通过桌面陪伴设备与你相处。从认识一位伙伴到让 TA 来到桌面，只需要四步。</p></div><ol className="cp-steps"><li><span>01</span><h3>准备好你的主机</h3><p>连接运行 Eidolon OS 的个人 AI 主机。在 Mobile 中管理你的伙伴和设备。</p><a href="/one">了解 Eidolon One ↗</a></li><li><span>02</span><h3>认识一位伙伴</h3><p>从预设开始，也可以自己定义。改名字、调整相处方式，先试聊一句。</p></li><li><span>03</span><h3>让 TA 来到桌面</h3><p>接入兼容陪伴设备，选择由哪位伙伴回应，再设置这台设备的表达方式。</p></li><li><span>04</span><h3>按自己的节奏相处</h3><p>以后可以再认识新伙伴、连接新设备。每位伙伴保持自己的设定，每台设备明确由谁回应。</p></li></ol></section>
    ...
    <section className="cp-status cp-section"><p className="cp-label">ONE HOST, MORE SCENES</p><h2>陪伴，只是一个开始。</h2><div className="cp-status-grid"><article><b>让几位伙伴一起聊</b><p>单独聊、一起出主意、放手让他们讨论，伙伴们在各自的设备上轮流回应。</p><a className="cp-text-link" href="/ensemble">看看 IP 角色团 ↗</a></article><article><b>让伙伴帮你照看家</b><p>在书房对伙伴说「把客厅空调关了」，家里的设备跟着动起来。</p><a className="cp-text-link" href="/smart-home">看看智能家居 ↗</a></article></div><a className="cp-button" href="/one">认识伙伴背后的主机 <span>↗</span></a></section>
    <footer className="cp-footer"><a href="/">Eidolon</a><p>你的 AI，你的记忆，你的决定。</p><a href="#top">回到顶部 ↑</a></footer>
  </main>;
}
