  ...
  return (
    <div className={`platform-architecture${compact ? " compact" : ""}`} aria-label="Eidolon OS 与 EID-X 支撑官方旗舰、官方外设和生态设备的系统架构">
      ...
      <div className="pa-products">
        ...
        <article><small>PARTNER ECOSYSTEM</small><h3>Compatible Devices</h3><p>汽车 · 家电 · 机器人 · 新终端</p></article>
      </div>
      <div className="pa-os">
      ...
      <div className="pa-hardware"><span>Compute</span><span>Sensors</span><span>Displays</span><span>Vehicles</span><span>Robotics</span></div>
    </div>
  );
}
